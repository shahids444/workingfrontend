...
import { FaArrowRightToCity, FaTicket } from "react-icons/fa6";
  ...
  useEffect(() => {
    const fetchProducts = async () => {
      try {
        ...
        const response2 = await fetch("https://backend-v0ii.onrender.com/api/blogs/");
                  ...
                  <div className="col-xl-4 col-md-6">
                    <div className="featured_listing_item_2">
                      ...
                      <div className="featured_listing_item_text">
                        ...
                        <Link className="title" to={`/listing/${product._id}`}>
                          {product.name}
                        </Link>
                        <ul>
                          <li>
                  ...
                  <div>
                    ...
                    >
                      <div className="wsus__single_testimonial_2">
                        ...
                        <div className="wsus__testimonial_footer">
                          <div className="img">
                            <img src={img1} alt="user" className="img-fluid" />
                          </div>
                          <h3>
                            Vinay
                            <span>CEO</span>
