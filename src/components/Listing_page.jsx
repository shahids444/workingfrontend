                    ...
                    >
                      <form id="loginFormSubmit">
                        <input
                          type="hidden"
                          name="_token"
                          defaultValue="OVKgoiBy67CAOS795E1tP9CewlhSjwBX99KggYWS"
                          autoComplete="off"
                        />{" "}
                        <input
                          type="email"
 ...
 LOG IN POPUP END
    ...
    ===========================*/}
        <div
          ...
          style={{
            "background-image":
              "url(https://dirlist.websolutionus.com/uploads/website-images/banner-2021-09-08-12-45-32-8135.jpg)",
          }}
        >
              ...
              <div className="col-xl-9 col-lg-8">
                <div className="row">
                  <div className="col-xl-12">
                    <div className="wsus__property_topbar"></div>
                  </div>
                              ...
                              <div className="col-12 col-xl-12 col-md-12">
                                <div className="map_popup_content">
                                  ...
                                  <div className="map_popup_text">
                                    ...
                                    <p>
                                      High-rise and city living with
